...
# ************ GLOBALS ***************
infolder <- "~/deBruin_add_nndm/10_experimental_samples/samples/sampled_3000"
...
folder_name <- "nndm_sampled3000_samps_1000_mint_0"
...
mclapply(list("AGB", "OCS"), function(var) {
  for(smpl in samples) {
    nndmCV(smpl = smpl, number = index_, variate = var)
  }
}, mc.cores = 2)
