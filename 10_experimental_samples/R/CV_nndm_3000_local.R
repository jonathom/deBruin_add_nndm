...
.libPaths("~/R")
library(ranger)
source("~/iloek_job/HannaMeyer/CAST/R/global_validation.R")
source("~/iloek_job/HannaMeyer/CAST/R/nndm.R")
library(lwgeom)
library(sf)
library(raster)
library(caret)
...
# ************ GLOBALS ***************
infolder <- "~/iloek_job/wadoux/deBruin_add_nndm/10_experimental_samples/samples/sampled_700"
outfolder <- "~/iloek_job/wadoux/deBruin_add_nndm/10_experimental_samples/CVresults/"
# outfolder <- "~/iloek_job/wadoux/investigate_spatial_validation/debruin/CVresults"
datafolder <- "~/iloek_job/wadoux/deBruin_add_nndm/data"
folder_name <- "nndm_sampled700_samps_1000_mint_0_local"
